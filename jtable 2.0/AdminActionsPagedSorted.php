...
try
{
	...
	else if($_GET["action"] == "update")
	{
		//Update record in database
            $result = mysql_query("UPDATE admin SET username = '" . $_POST["username"] . "',password = '" . $_POST["password"] . "',cpassword = '" . $_POST["cpassword"] . "',role = '" . $_POST["role"] . "'  WHERE admin_id = " . $_POST["admin_id"] . ";");
