 ...
 */
class AssessmentMetrics extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('score, total, test_id, worker_id, facility_id', 'required'),
			array('score, total, facility_id', 'numerical', 'integerOnly'=>true),
			array('test_id, worker_id', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('session_id, date_taken, score, total, test_id, worker_id, facility_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return AssessmentMetrics the static model class
	 */
