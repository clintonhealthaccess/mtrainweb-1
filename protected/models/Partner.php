...
class Partner extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('partner_name, remarks', 'required'),
			array('partner_name, remarks', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('partner_id, partner_name, remarks', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'systemAdmins' => array(self::HAS_MANY, 'SystemAdmin', 'partner_id'),
		);
	}
