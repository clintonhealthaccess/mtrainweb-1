 ...
 */
class UsageMetrics extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('session_type, material_type, worker_id, module_id, training_id, facility_id', 'required'),
			...
			array('session_id, start_time, end_time, status, session_type, material_type, worker_id, module_id, training_id, facility_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return UsageMetrics the static model class
	 */
