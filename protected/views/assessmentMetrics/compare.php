            ...
            <section class="container">
                ...
                <article>
                    <div class="row noborder marginbottom15">
                        <div class="col-md-12">
                            <h3 class="bluetextcolor aligncenter">Assessment Metrics Comparison</h3>
                        </div>
                    </div>
   ...
   <script type="text/javascript">
      ...
      $(document).ready(function(){ 
        ...
        $('#filterButton').click(function (e){             
                    ...
                    url = '../assessmentMetrics/ajaxList';
             ...
             function addComparisonRows(recordsObj, selectionString, selectionJSON){
                 ...
                 html += '<tr>' +
                                '<th>Cadre Name</th>' +
                                '<th>No. of HCWs</th>' +
                                '<th>No. Taking Tests</th>' +
                                '<th>No. of Tests Taken</th>' +
                                '<th>High Performing Score</th>' +
                                '<th>Average Score</th>' +
                                '<th>Underperforming Score</th>' +
                                '<th>Failed Score</th>' +
                            '</tr>';
                 ...
                 for(key in recordsObj){
                     ...
                     html += '<tr class="' + classes + '">' +
                                ...
                                '<td>' + record.num_hcw_taking_tests + '</td>' +
                                '<td>' + record.num_tests_taken + '</td>' +
                                '<td>' + record.high_performing_score + '</td>' +
                                '<td>' + record.average_score + '</td>' +
                                '<td>' + record.underperforming_score + '</td>' +
                                '<td>' + record.failed_score + '</td>' +
                              '</tr>';
                 }
